...
<body style="background-image: url('./images/register.jpg');">
  ...
  <div class="card opacity-100" style="width: 28rem; margin-left: 450px; margin-top: 200px;color:black; background-color:rgba(255, 255, 255, 0.5);">
    ...
    if ($name != "" and $password != "") {
      ...
      if ($result->num_rows == 1) {
        ...
        if ($row['Username'] == $name && $row['Password']==$password) {
          ...
          display_alert(["Incorrect Password or Username"]);
        }
